# AxolotlClient-Config Example Mod

A template / example for using this Config Library in Minecraft 1.19.2.
...
This template on the AxolotlClient GitHub is licensed under the [Creative Common Zero v1.0 license](./LICENSE-TEMPLATE.md).

Mods created with this template are not automatically licensed under the CC0, and are not required to give any kind of credit back to AxolotlClient for this template.

## Credits

This template is based on the Quilt Template Mod.
